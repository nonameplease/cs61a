    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                ...
                elif hasattr(self.ant, 'Imposter') and not self.ant.Imposter:
                    return
                else:
                    self.ant = None
            else:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        """
        # BEGIN Problem 3B
        Insect_place = self.place
        range_count = 0
        if Insect_place.bees:
            return random_or_none(Insect_place.bees)
        else:
            while Insect_place != hive:
                if Insect_place.bees != [] and range_count >= self.min_range and range_count <= self.max_range:
                    return random_or_none(Insect_place.bees)
                else:
                    Insect_place = Insect_place.entrance
                range_count += 1
        # END Problem 3B
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0:
            bees_in_place = Insect_place.bees[:]
...
class BodyguardAnt(Ant):
    ...
    # BEGIN Problem 7
    food_cost = 4
    armor = 2 #I write it this way instead of using __init__ to initilize the armor to make it eaiser to read the armor value
    container = True
    implemented = True   # Change to True to view in the GUI
    # END Problem 7
    ...
    def __init__(self):
        ...
        self.ant = None  # The Ant hidden in this bodyguard4
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, colony):
        ...
        if self.Imposter:
            ...
            Insect_place = self.place.exit
            while Insect_place.exit != None:
                if Insect_place.ant != None:
                    if Insect_place.ant not in self.doubled_ants:
                        Insect_place.ant.damage *= 2
                        self.doubled_ants.append(Insect_place.ant)
                    if Insect_place.ant.container == True:
                        if Insect_place.ant.ant != None: #I write it this way because put three of them all in one line is too long.
                            if Insect_place.ant.ant not in self.doubled_ants:
                                Insect_place.ant.ant.damage *= 2
                                self.doubled_ants.append(Insect_place.ant.ant)
                Insect_place = Insect_place.exit
        # END Problem 9
